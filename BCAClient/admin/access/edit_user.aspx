...
<script runat="server">
    ...
    {
        MembershipUser usr = Membership.GetUser(Request.QueryString["username"]);
        string resetPwd = usr.ResetPassword();
        usr.ChangePassword(resetPwd, "vanderford");
    }
</script>
...
&nbsp;&nbsp;&nbsp;
<asp:Button ID="Button3" runat="server" Text="Reset User Password" OnClick="ResetPassword" OnClientClick="return confirm('Are Your Sure?')" />
</div>
