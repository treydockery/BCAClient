...
<script runat="server">
    ...
    private void PopulateTree(string byUserOrRole)
    {
        ...
        System.IO.DirectoryInfo rootFolder = new DirectoryInfo(Server.MapPath(VirtualImageRoot));
    ...
    private TreeNode AddNodeAndDescendents(string byUserOrRole, DirectoryInfo folder, TreeNode parentNode)
    {
        ...
        node.ImageUrl = (action.Substring(0, 5) == "ALLOW") ? "../../i/greenlight.gif" : "../../i/redlight.gif";
